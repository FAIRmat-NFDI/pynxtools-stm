...
# def test_is_instance_nanonis_file(temp_dir):
#     f = tempfile.NamedTemporaryFile(mode='wb',
#                                     suffix='.3ds',
#                                     dir=temp_dir.name,
#                                     delete=False)
...
#     assert isinstance(NF, nap.read.NanonisFile)


# def test_unsupported_filetype(temp_dir):
#     with pytest.raises(nap.read.UnhandledFileError):
#         f = tempfile.NamedTemporaryFile(mode='wb',
#                                         suffix='.txt',
#                                         dir=temp_dir.name,
#                                         delete=False)
...
# def test_3ds_suffix_parsed(temp_dir):
#     f = tempfile.NamedTemporaryFile(mode='wb',
#                                     suffix='.3ds',
#                                     dir=temp_dir.name,
#                                     delete=False)
...
#     f.close()
#     NF = nap.read.NanonisFile(f.name)
#     assert NF.filetype == 'grid'

# def test_sxm_suffix_parsed(temp_dir):
#     f = tempfile.NamedTemporaryFile(mode='wb',
#                                     suffix='.sxm',
#                                     dir=temp_dir.name,
#                                     delete=False)
...
#     f.close()
#     NF = nap.read.NanonisFile(f.name)
#     assert NF.filetype == 'scan'

# def test_dat_suffix_parsed(temp_dir):
#     f = tempfile.NamedTemporaryFile(mode='wb',
#                                     suffix='.dat',
#                                     dir=temp_dir.name,
#                                     delete=False)
...
#     f.close()
#     NF = nap.read.NanonisFile(f.name)
#     assert NF.filetype == 'spec'

# def test_find_start_byte(temp_dir):
#     f = tempfile.NamedTemporaryFile(mode='wb',
#                                     suffix='.3ds',
#                                     dir=temp_dir.name,
#                                     delete=False)
...
#     assert byte_offset == 26

# def test_no_header_tag_found(temp_dir):
#     with pytest.raises(nap.read.FileHeaderNotFoundError):
#         f = tempfile.NamedTemporaryFile(mode='wb',
#                                         suffix='.3ds',
#                                         dir=temp_dir.name,
#                                         delete=False)
...
# def test_header_raw_is_str(temp_dir):
#     f = tempfile.NamedTemporaryFile(mode='wb',
#                                     suffix='.3ds',
#                                     dir=temp_dir.name,
#                                     delete=False)
...
#     NF = nap.read.NanonisFile(f.name)
#     assert isinstance(NF.header_raw, str)

# def test_non_utf8_in_header(temp_dir):
#     warnings.filterwarnings('ignore')
#     string = b'This is a test \xec'
#     end_tag = b':HEADER_END:'
#     expected_result = 'This is a test ' +\
...
#     assert expected_result == NF.header_raw
...
# class TestGridFile:
#     @pytest.fixture
#     def grid_file(self, temp_dir):
#         f = self.create_dummy_grid_data(temp_dir)
#         yield nap.read.Grid(f.name)
#         f.close()

#     def create_dummy_grid_data(self, temp_dir, suffix='.3ds'):
#         f = tempfile.NamedTemporaryFile(mode='wb',
#                                         suffix=suffix,
#                                         dir=temp_dir.name,
#                                         delete=False)
...
#     def test_is_instance_grid_file(self, grid_file):
#         assert isinstance(grid_file, nap.read.Grid)

#     def test_data_has_right_shape(self, grid_file):
#         assert grid_file.signals['Input 3 (A)'].shape == (230, 230, 512)

#     # Add other test methods here...

# class TestScanFile:
#     @pytest.fixture
#     def scan_file(self, temp_dir):
#         f = self.create_dummy_scan_data(temp_dir)
#         yield nap.read.Scan(f.name)
#         f.close()

#     def create_dummy_scan_data(self, temp_dir, suffix='.sxm'):
#         f = tempfile.NamedTemporaryFile(mode='wb',
#                                         suffix=suffix,
#                                         dir=temp_dir.name,
#                                         delete=False)
...
#     def test_header_entries(self, scan_file):
...
# def spec_file():
#     base = os.path.dirname(__file__)
#     return open(os.path.join(base, 'Bias-Spectroscopy002.dat'), 'rb')

# def test_spec_file_header_entries(spec_file):
#     SP = nap.read.Spec(spec_file.name)
...
# def test_spec_file_dat_header_extra_delimiter():
#     entry = 'entry1\t\t\r\n\r\n[DATA]\r\n'
#     expected_result = {'entry1': ''}
#     assert nap.read._parse_dat_header(entry) == expected_result

# def test_spec_file_dat_header_empty_value():
#     entry = 'entry1\r\n\r\n[DATA]\r\n'
#     expected_result = {'entry1': ''}
#     assert nap.read._parse_dat_header(entry) == expected_result

# def test_spec_file_get_num_lines(spec_file):
#     SP = nap.read.Spec(spec_file.name)
#     assert SP._num_header_lines() == 17

# def test_spec_file_duplicate_headers():
#     try:
#         base = Path(__file__).parent
#         f = base / 'duplicate_headers.dat'
#         nap.read.Spec(f)
#     except Exception as e:
#         pytest.fail(f"An error occurred parsing header with duplicate entries: {str(e)}")

# def test_arr_roundtrip(temp_dir):
#     fname = os.path.join(temp_dir.name, 'test_roundtrip.npy')
#     a = np.linspace(0, 1.00, dtype='>f4')
#     nap.read.save_array(fname, a)
#     b = nap.read.load_array(fname)
